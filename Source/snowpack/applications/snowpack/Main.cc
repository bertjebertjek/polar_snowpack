         ...
         sector_width(0)
{
	...
	cfg.getValue("SNOW_EROSION", "SnowpackAdvanced", snow_erosion); // DEFAULT in Config is False, and the code checks for None, therefore , we erode at the main station even when we don't want to!
